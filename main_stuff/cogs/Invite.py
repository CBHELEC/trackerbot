...
# GEOCACHING
    ...
    async def geocaching(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(f"You wanted to join the most active Geocaching server? Here's the permanent invite! discord.gg/r4XnnaYtWs", ephemeral=False)
